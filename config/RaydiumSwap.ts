...
class RaydiumSwap {
  ...
  async getSwapTransaction(
    ...
    const swapTransaction = await Liquidity.makeSwapInstructionSimple({
      ...
      makeTxVersion: 0,   // use VersionedTransaction
      poolKeys: {
        ...poolKeys,
      },
      userKeys: {
  ...
  async calcAmountOut(
    ...
    console.log(amountOut.toFixed(), "amount out")
    console.log(minAmountOut.toFixed(), "amount out")
    console.log(currentPrice.toFixed(), "amount out")
    if (executionPrice) console.log(executionPrice.toFixed(), "amount out")
    return {
      amountIn,
      amountOut,
      minAmountOut,
